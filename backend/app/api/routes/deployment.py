...
async def create_deployment(
    request: DeployRequest, user: dict = Depends(get_current_user)
):
...
async def start_deployment(
    deployment_id: str, user: dict = Depends(get_current_user)
):
...
async def list_deployments(
    project_id: str = None, user: dict = Depends(get_current_user)
):
