...
## Project Knowledge
- **Project Name:** OnRamp — AI-powered Azure Landing Zone Architect & Deployer
- **Repository:** JoshLuedeman/onramp
- **Issue Tracker:** https://github.com/JoshLuedeman/onramp/issues
- **Milestone / Epic Structure:** GitHub milestones track feature areas (Questionnaire, Architecture, Compliance, Bicep, Deployment); issues are broken into sub-tasks per the core workflow: Questionnaire → Architecture Generation → Compliance Scoring → Bicep Preview → Deployment
- **Stakeholders:** @JoshLuedeman (owner/lead)
