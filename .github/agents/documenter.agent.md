...
## Project Knowledge
- **Doc Build Command:** No build step — docs are plain Markdown files
- **Doc Preview Command:** API docs auto-generated at `http://localhost:8000/docs` (Swagger UI) when backend is running (`./dev.sh up`)
- **Changelog Format:** Conventional Commits; changes tracked via git log with `feat:`, `fix:`, `docs:`, `refactor:`, `test:`, `chore:` prefixes
- **Doc Directory:** `docs/` at repo root (`docs/architecture.md`, `docs/api.md`, `docs/development.md`); `README.md` for project overview; `.github/copilot-instructions.md` for Copilot context; `AGENTS.md` for coding agent instructions
