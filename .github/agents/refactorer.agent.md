...
## Project Knowledge
- **Tech Stack:** React 19 + TypeScript 5.9 + Vite 7 + Fluent UI React v9 (frontend), Python 3.12 + FastAPI + SQLAlchemy 2.0 async + Alembic (backend), Azure SQL / SQLite (database), Bicep (IaC)
...
- **Code Quality Tools:** Ruff (Python linting + formatting, rules: E, F, I, N, W, UP, 100 char line length); ESLint 9+ with typescript-eslint (frontend); pytest-cov and @vitest/coverage-v8 for coverage enforcement
